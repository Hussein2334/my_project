<x-layout>
    ...
    <h1 class="text-2xl font-bold mb-6 text-center">Register a new account</h1>

    <div class="mx-auto max-w-screen-sm bg-white shadow-md rounded-lg p-8">
        <form action="{{ route('register') }}" method="POST"z>
            @csrf
            ...
            <div class="mb-6">
                ...
                <input type="text" name="username" id="username" 
                    ...
                    @error('username') border-red-500 ring-2 ring-red-500 focus:ring-red-500 focus:border-red-500 @else border-gray-300 focus:ring-indigo-500 focus:border-indigo-500 @enderror" 
